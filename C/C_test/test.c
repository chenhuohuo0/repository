...
//		char c1;//1
//		struct s3 s;//8
//		//如果嵌套结构体s,s的对齐数是s的成员变量中的最大对齐数
//		double d;//8
//	};//32
//	struct s3 s1 = {0.5,5.5,'c',1};
//	struct s4 s2 = {'x',s1};
//	printf("%d", sizeof(s2));
//}
...
//{
	...
	//struct S s = { 0 };
	//fscanf(stdin, "%d %f %s", &(s.n), &(s.score), s.arr);//从标准输入流中格式化读取
